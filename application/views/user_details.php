...
<body>
  ...
  <div class="filter-section">
    <div class="form-inline">
      <label for="gp_details" class="mr-2">Column:</label>
      <select id="gp_details" class="form-control mr-3">
        <option value="">Select Column</option>
        <?php foreach ($column_names as $column): ?>
          <option value="<?= $column ?>"><?= $column ?></option>
        <?php endforeach; ?>
      </select>
      <input type="text" id="data" placeholder="Enter value" class="form-control mr-2">
      <button class="btn btn-primary" onclick="applyFilter()">Submit</button>
    </div>
  </div>

  <div class="container-xxl">
    <div class="d-flex justify-content-between mb-3">
      <h4>GP Status Table</h4>
      <a href="<?php echo site_url("Home/export_to_csv"); ?>" class="btn btn-info mb-3">Export to CSV</a>
